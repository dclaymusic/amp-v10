...
function startSnd(page, selection)
{
    ...
    if(page == '4') { currentAudioDuration = 3; } //melody
    ...
    if(page == '16')
    {
        if(melodyChoice == 1 && accompChoice == 1 && melodyShape == 1 && instrument == 1) { currentAudioDuration = 234; }
        if(melodyChoice == 1 && accompChoice == 1 && melodyShape == 1 && instrument == 2) { currentAudioDuration = 234; }
        if(melodyChoice == 1 && accompChoice == 1 && melodyShape == 2 && instrument == 1) { currentAudioDuration = 237; }
        if(melodyChoice == 1 && accompChoice == 1 && melodyShape == 2 && instrument == 2) { currentAudioDuration = 237; }

        if(melodyChoice == 1 && accompChoice == 2 && melodyShape == 1 && instrument == 1) { currentAudioDuration = 234; }
        if(melodyChoice == 1 && accompChoice == 2 && melodyShape == 1 && instrument == 2) { currentAudioDuration = 234; }
        if(melodyChoice == 1 && accompChoice == 2 && melodyShape == 2 && instrument == 1) { currentAudioDuration = 237; }
        if(melodyChoice == 1 && accompChoice == 2 && melodyShape == 2 && instrument == 2) { currentAudioDuration = 237; }

        if(melodyChoice == 2 && accompChoice == 1 && melodyShape == 1 && instrument == 1) { currentAudioDuration = 236; }
        if(melodyChoice == 2 && accompChoice == 1 && melodyShape == 1 && instrument == 2) { currentAudioDuration = 236; }
        if(melodyChoice == 2 && accompChoice == 1 && melodyShape == 2 && instrument == 1) { currentAudioDuration = 239; }
        if(melodyChoice == 2 && accompChoice == 1 && melodyShape == 2 && instrument == 2) { currentAudioDuration = 239; }

        if(melodyChoice == 2 && accompChoice == 2 && melodyShape == 1 && instrument == 1) { currentAudioDuration = 237; }
        if(melodyChoice == 2 && accompChoice == 2 && melodyShape == 1 && instrument == 2) { currentAudioDuration = 237; }
        if(melodyChoice == 2 && accompChoice == 2 && melodyShape == 2 && instrument == 1) { currentAudioDuration = 240; }
        if(melodyChoice == 2 && accompChoice == 2 && melodyShape == 2 && instrument == 2) { currentAudioDuration = 240; }
    }
    ...
    if(page == '16') {
        ...
        let dur3 = 61;
        let dur4 = 117;
        if(melodyChoice == 1 && accompChoice == 1) { dur1 = 26; m1 = '01-melodyAlegato'; }
        if(melodyChoice == 1 && accompChoice == 2) { dur1 = 26; m1 = '01-melodyAstaccato'; }
        if(melodyChoice == 2 && accompChoice == 1) { dur1 = 28; m1 = '01-melodyBlegato'; }
        if(melodyChoice == 2 && accompChoice == 2) { dur1 = 29; m1 = '01-melodyBstaccato'; }
        if(melodyShape == 1) { dur2 = 30; m2 = '02-rising'; }
        if(melodyShape == 2) { dur2 = 33; m2 = '02-falling'; }
